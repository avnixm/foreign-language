...
export const lessons: Lesson[] = [
  ...
  },
  {
    id: 6,
    title: "Coming Soon",
    description: "This lesson is currently being developed. Check back soon!",
    estimatedMinutes: 5,
    vocabulary: [
      { word: "まもなく", reading: "mamonaku", meaning: "coming soon" },
    ],
    grammar: [
      {
        title: "Coming Soon",
        explanation: "This lesson content is being prepared.",
        examples: [],
      },
    ],
    conversations: [],
    culturalNotes: [
      "This lesson is currently under development. More content will be added soon!",
    ],
    quiz: [
      {
        id: 1,
        type: 'multiple-choice',
        question: "This lesson is coming soon!",
        options: ["Okay", "Great", "Looking forward to it", "All of the above"],
        correctAnswer: "All of the above",
        explanation: "Lesson 6 is being prepared and will be available soon!",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        options: ["Okay", "Great", "Looking forward to it", "All of the above"],
        correctAnswer: "All of the above",
        explanation: "Lesson 10 is being prepared and will be available soon!",
      },
    ],
  },
];
